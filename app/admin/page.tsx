...
export default function AdminPage() {
  ...
  const handleLogin = async () => {
    setLoading(true)
    try {
      const response = await fetch('https://esaki-jrr.com/telas/api/auth/login', {
        method: 'POST',
        headers: {
  ...
  const loadFabrics = async () => {
    try {
      const response = await fetch('https://esaki-jrr.com/telas/api/fabrics')
      if (response.ok) {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const response = await fetch('https://esaki-jrr.com/telas/api/upload', {
        method: 'POST',
        body: formData,
      })
  ...
  ? `https://esaki-jrr.com/telas/api/fabrics/${editingFabric.id}`
  : 'https://esaki-jrr.com/telas/api/fabrics'
  ...
  const handleDelete = async (id: number) => {
    try {
      const response = await fetch(`https://esaki-jrr.com/telas/api/fabrics/${id}`, {
        method: 'DELETE',
      })
